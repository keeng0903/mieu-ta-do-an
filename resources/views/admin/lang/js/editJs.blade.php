...
<script>
    function runEnglishUdate()
    {
        ...
        var id_en = localStorage.clickcount;
        var htmlObj
        ...
        if (id_en == 1) {
            ...
            htmlObj.innerHTML = htmlObj.innerHTML + '<div class="card-body" id="show-update-'+localStorage.clickcount+'"><div id="'+localStorage.clickcount+'"><div class="form-group">' +
            ...
            if (htmlObj){
                ...
                htmlObj.innerHTML = htmlObj.innerHTML + '<div id="'+localStorage.clickcount+'"><div class="form-group">' +
                    '<label for="inputName">'+ localStorage.clickcount +' - Tiêu đề </label> ' +
                    '<input type="text" id="titleEn" name="lang['+ localStorage.clickcount +'][title]" class="form-control" value=""> ' +
                    '</div>' +
                    '<div class="form-group"> ' +
    ...
    function removeOptionUpdate(id){
        ...
        $("#show-update-"+id).hide();
        var parent = document.getElementById("show-update-"+id);
